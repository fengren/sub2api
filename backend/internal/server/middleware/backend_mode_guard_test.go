...
func TestBackendModeAuthGuard(t *testing.T) {
	tests := []struct {
		...
		{
			name:       "enabled_allows_feishu_qr_init",
			enabled:    "true",
			path:       "/api/v1/auth/oauth/feishu/qr/init",
			wantStatus: http.StatusOK,
		},
		{
			name:       "enabled_allows_feishu_qr_page",
			enabled:    "true",
			path:       "/api/v1/auth/oauth/feishu/qr/page",
			wantStatus: http.StatusOK,
		},
		{
			name:       "enabled_allows_feishu_qr_verify",
			enabled:    "true",
			path:       "/api/v1/auth/oauth/feishu/qr/verify",
			wantStatus: http.StatusOK,
		},
		{
