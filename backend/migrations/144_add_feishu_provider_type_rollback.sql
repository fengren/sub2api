-- Rollback for 144_add_feishu_provider_type.sql
-- Removes 'feishu' from all CHECK constraints, restoring the pre-migration state.
-- NOTE: This will fail if any rows have signup_source/provider_type = 'feishu'.
