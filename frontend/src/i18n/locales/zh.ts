export default {
  ...
  auth: {
    ...
    feishu: {
      ...
      error: {
        ...
        userinfo_failed: '获取飞书用户信息失败',
        missing_browser_session: '浏览器会话丢失，请重新登录',
        missing_params: '请求参数不完整',
        invalid_state: '登录状态异常',
        provider_error: '飞书授权失败',
        tenant_rejected: '当前飞书组织未被允许登录',
        session_error: '会话创建失败，请重试',
        retry: '重新登录'
      }
    },
  ...
  admin: {
    ...
    settings: {
      ...
      feishu: {
        title: '飞书登录',
        description: '配置飞书 OAuth，用于 Sub2API 用户扫码登录',
        enable: '启用飞书登录',
        enableHint: '在登录/注册页面显示飞书扫码登录入口',
        clientId: 'Client ID（App ID）',
        clientIdPlaceholder: '例如：cli_xxxxxxxxxxxxx',
        clientIdHint: '从飞书开放平台应用详情页获取',
        ...
        redirectUrlHint: '需与飞书开放平台中配置的回调地址一致（必须是 http(s) 完整 URL）',
        tenantOptions: '多组织配置',
        tenantOptionsHint: '每个组织配置对应 tenant_key、App ID 和 App Secret；登录页会使用对应应用发起扫码。',
        tenantOptionsEmpty: '未配置组织；启用飞书登录时至少需要配置一个组织。',
        tenantName: '组织名称',
        tenantNamePlaceholder: '例如：研发组织',
        tenantGroup: '默认分组',
        tenantGroupNone: '不绑定分组',
        bypassRegistration: '开放飞书注册',
        bypassRegistrationHint: '即使「开放注册」关闭时也可以通过本租户飞书账号注册',
        syncDisplayName: '同步飞书姓名',
        syncDisplayNameHint: '登录时将飞书姓名记录到用户属性',
        syncCorpEmail: '同步企业邮箱',
        syncCorpEmailHint: '登录时将飞书企业邮箱记录到用户属性（不影响登录邮箱）'
      },
      oidc: {
        title: 'OIDC 登录',
