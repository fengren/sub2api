export default {
  ...
  auth: {
    ...
    signIn: 'Sign In',
    emailPasswordLogin: 'Email Login',
    ...
    feishu: {
      ...
      scanLogin: 'Scan to sign in with Feishu',
      organization: 'Organization',
      scanHint: 'Scan the QR code with Feishu app',
      scanned: 'Scanned, please confirm in Feishu',
      qrExpired: 'QR code expired',
      qrCancelled: 'Scan cancelled',
      ...
      error: {
        ...
        userinfo_failed: 'Failed to fetch Feishu user info',
        missing_browser_session: 'Browser session lost. Please login again',
        missing_params: 'Request parameters are incomplete',
        invalid_state: 'Invalid login state',
        provider_error: 'Feishu authorization failed',
        tenant_rejected: 'This Feishu organization is not allowed to sign in',
        session_error: 'Failed to create session. Please retry',
        retry: 'Retry Login'
      }
    },
  ...
  admin: {
    ...
    settings: {
      ...
      feishu: {
        title: 'Feishu Login',
        description: 'Configure Feishu OAuth for Sub2API QR sign-in',
        enable: 'Enable Feishu Login',
        enableHint: 'Show Feishu QR login on the login/register pages',
        clientId: 'Client ID (App ID)',
        clientIdPlaceholder: 'e.g., cli_xxxxxxxxxxxxx',
        clientIdHint: 'Get this from the Feishu Open Platform app details',
        ...
        redirectUrlHint:
          'Must match the redirect URL configured in Feishu Open Platform (must be an absolute http(s) URL)',
        tenantOptions: 'Multiple organizations',
        tenantOptionsHint: 'Configure tenant_key, App ID, and App Secret per organization. The login page uses the selected app for QR sign-in.',
        tenantOptionsEmpty: 'No organization configured. At least one organization is required when Feishu login is enabled.',
        tenantName: 'Organization name',
        tenantNamePlaceholder: 'For example Engineering',
        tenantGroup: 'Default group',
        tenantGroupNone: 'No group',
        bypassRegistration: 'Enable Feishu signup',
        bypassRegistrationHint: 'Allow new users from this tenant to register via Feishu even when public registration is disabled.',
        syncDisplayName: 'Sync Feishu display name',
        syncDisplayNameHint: 'Store the Feishu display name in a user attribute on login.',
        syncCorpEmail: 'Sync corporate email',
        syncCorpEmailHint: 'Store the Feishu corporate email in a user attribute on login (does not change the login email).'
      },
      oidc: {
        title: 'OIDC Login',
